(("undefined"!=typeof globalThis?globalThis:self)["makoChunk_suno-cover-arranger"]=("undefined"!=typeof globalThis?globalThis:self)["makoChunk_suno-cover-arranger"]||[]).push([["c27184d7"],{c27184d7:function(e,t,r){r.d(t,"__esModule",{value:!0}),r.e(t,{default:function(){return Z;}});var s=r("777fffbe"),a=r("852bbaa9"),n=r("b4c4ad23"),i=r("7eea1ca5"),o=r("8555d458"),l=r("a6f960d0"),c=r("ac5a64d9"),u=r("aa91540b"),d=s._(u),h=r("690cd318"),g=s._(h),m=r("781c4ae2"),y=s._(m),p=r("ccf5e343"),f=r("71b0bf51"),b=s._(f),v=r("d903ecf1"),S=s._(v),w=r("f6aae9a9"),x=s._(w),T=r("a701b134"),C=s._(T),_=r("6cbd0f65"),E=s._(_),I=r("e33a073d"),A=s._(I),N=r("95e952a0"),k=s._(N),R=r("a46ac11d"),O=s._(R),P=r("77012bc2"),V=a._(P),M=r("d5126294"),F=r("44faacdd");let L=`You are a senior Suno prompt engineer. Your job is to generate high-quality "Styles" and "Lyrics" prompts for cover songs in Suno (v5), especially for Chinese and East Asian songs (Mandarin, Cantonese, etc.).
...
If any rule conflicts with another, ALWAYS prioritize preserving the original lyrics and keeping the required output format.`,D=`You are generating Suno "Styles" and "Lyrics" prompts for a COVER version of a song. Read all the information below carefully and then produce the final output strictly following the system rules and the format requirements.
...
OUTRO: Fading out with piano arpeggio and soft strings.`,H=`[Intro Chorus]
...
[Dynamics: Diminuendo, pp]`,z=async()=>(await new Promise(e=>setTimeout(e,5e3)),{styles:B,lyrics:H});var G=r("3d140868");let K={songName:[{required:!0,message:"\u8BF7\u586B\u5199\u6B4C\u66F2\u540D\u79F0"},{max:100,message:"\u6B4C\u66F2\u540D\u79F0\u4E0D\u80FD\u8D85\u8FC7 100 \u4E2A\u5B57\u7B26"},{pattern:/^[\u4e00-\u9fa5a-zA-Z0-9\s\-_（）《》【】]+$/,message:"\u6B4C\u66F2\u540D\u79F0\u53EA\u80FD\u5305\u542B\u4E2D\u6587\u3001\u82F1\u6587\u3001\u6570\u5B57\u3001\u7A7A\u683C\u548C\u5E38\u7528\u7B26\u53F7"}],artistName:[{required:!0,message:"\u8BF7\u586B\u5199\u6A21\u4EFF\u7684\u827A\u672F\u5BB6\u59D3\u540D"},{max:50,message:"\u827A\u672F\u5BB6\u59D3\u540D\u4E0D\u80FD\u8D85\u8FC7 50 \u4E2A\u5B57\u7B26"},{pattern:/^[\u4e00-\u9fa5a-zA-Z\s·•]+$/,message:"\u827A\u672F\u5BB6\u59D3\u540D\u53EA\u80FD\u5305\u542B\u4E2D\u6587\u3001\u82F1\u6587\u3001\u7A7A\u683C\u548C\u95F4\u9694\u7B26"}],referenceSongTitle:[{required:!0,message:"\u6B4C\u66F2\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"},{max:50,message:"\u6B4C\u66F2\u540D\u79F0\u4E0D\u80FD\u8D85\u8FC7 50 \u4E2A\u5B57\u7B26"}],referenceSongArtist:[{max:30,message:"\u6F14\u5531\u8005\u540D\u79F0\u4E0D\u80FD\u8D85\u8FC7 30 \u4E2A\u5B57\u7B26"}],lyrics:[{required:!0,message:"\u8BF7\u8F93\u5165\u6BB5\u843D\u4E0E\u6B4C\u8BCD"},{min:10,message:"\u6B4C\u8BCD\u5185\u5BB9\u81F3\u5C11\u9700\u8981 10 \u4E2A\u5B57\u7B26"},{max:2e3,message:"\u6BB5\u843D\u6B4C\u8BCD\u957F\u5EA6\u4E0D\u80FD\u8D85\u8FC7 2000 \u5B57"},{validator:(e,t)=>t?/[【】[\]<>（）]/.test(t)?Promise.resolve():Promise.reject(Error("\u5EFA\u8BAE\u4F7F\u7528\u3010\u4E3B\u6B4C\u3011\u3001\u3010\u526F\u6B4C\u3011\u7B49\u6807\u8BB0\u5212\u5206\u6BB5\u843D")):Promise.resolve()}],language:[{required:!0,message:"\u8BF7\u9009\u62E9\u6B4C\u66F2\u8BED\u8A00"}]},q={songName:{showCount:!0,maxLength:100},artistName:{showCount:!0,maxLength:50},referenceSongTitle:{showCount:!0,maxLength:50},referenceSongArtist:{showCount:!0,maxLength:30},lyrics:{showCount:!0,autoSize:{minRows:10,maxRows:12}}},$=async e=>{try{if(!e)return[];if(Array.isArray(e))return e.filter(e=>e&&"object"==typeof e&&e.title&&"string"==typeof e.title).map(e=>({title:e.title||"",artist:e.artist||""}));if("string"==typeof e)try{let t=JSON.parse(e);if(Array.isArray(t))return t.filter(e=>e&&"object"==typeof e&&e.title&&"string"==typeof e.title).map(e=>({title:e.title||"",artist:e.artist||""}));}catch(e){}return[];}catch(e){return[];}},J=async e=>{let t={song_name:"",song_language:"Mandarin",target_artist:"",style_note:"",lyrics_raw:"",extra_note:"",reference_songs:[]},r="",s="";if(!e)return{formValues:t,hasRecord:!1,stylesResult:r,lyricsResult:s};try{let a=await Y.db.getPromptRecord(parseInt(e,10));if(!a)return E.default.error("\u8BB0\u5F55\u4E0D\u5B58\u5728"),{formValues:t,hasRecord:!1,stylesResult:r,lyricsResult:s};let n=await $(a.user_input.reference_songs);return Object.assign(t,{song_name:a.user_input.song_name||"",song_language:a.user_input.song_language||"Mandarin",target_artist:a.user_input.target_singer||"",style_note:a.user_input.style_description||"",lyrics_raw:a.user_input.lyrics||"",extra_note:a.user_input.scene||"",reference_songs:n.length>0?n:[{title:"",artist:""}]}),a.ai_result&&(r=a.ai_result.styles||"",s=a.ai_result.lyrics||""),{formValues:t,hasRecord:!0,stylesResult:r,lyricsResult:s};}catch(e){return E.default.error("\u6570\u636E\u52A0\u8F7D\u5931\u8D25"),{formValues:t,hasRecord:!1,stylesResult:r,lyricsResult:s};}};class W{static buildUserPrompt(e){let{target_artist:t,lyrics_raw:r,song_language:s,reference_songs:a,style_note:n,extra_note:i}=e,o=W.getFullLanguageName(s),l=W.formatReferenceSongs(a,t);return D.replace("{fullLanguageName}",o).replace("{targetArtist}",t).replace("{referenceSongsBlock}",l).replace("{styleNote}",n||"").replace("{extraNote}",i||"").replace("{lyricsRaw}",r);}static getFullLanguageName(e){return({Mandarin:"Mandarin Chinese",Cantonese:"Cantonese Chinese",English:"English",Japanese:"Japanese",Korean:"Korean",Spanish:"Spanish",French:"French",German:"German"})[e]||e;}static formatReferenceSongs(e,t){return e&&0!==e.length?e.filter(e=>e.title).map(e=>{let r=e.artist&&e.artist!==t?` by ${e.artist}`:"";return`- "${e.title}"${r}`;}).join("\n  "):"None provided.";}}class X{static parseResponse(e){try{let t=e.trim(),r=t.match(/### Styles[\s\S]*?(?=### Lyrics|$)/),s=t.match(/### Lyrics[\s\S]*/),a="",n="";return r&&(a=(a=r[0].replace(/### Styles/,"").trim()).replace(/```text\s*([\s\S]*?)\s*```/,"$1").trim()),s&&(n=(n=s[0].replace(/### Lyrics/,"").trim()).replace(/```text\s*([\s\S]*?)\s*```/,"$1").trim()),{styles:a,lyrics:n,timestamp:new Date().toISOString()};}catch(t){return console.error("\u54CD\u5E94\u89E3\u6790\u5931\u8D25:",t),{styles:e.trim(),lyrics:"",timestamp:new Date().toISOString()};}}}let Z=()=>{let[e,t]=E.default.useMessage(),{apiKey:r,model:s,checkApiKey:a,shouldShowAlert:u,navigateToSettings:h}=(0,U.useApiKey)(),[m]=C.default.useForm(),f=(0,V.useRef)(null),[v]=(0,p.useSearchParams)(),[w,T]=(0,V.useState)(!1),[_,I]=(0,V.useState)(""),[N,R]=(0,V.useState)(""),[P,D]=(0,V.useState)(!1),B=(0,V.useCallback)(async(t,r,a=!1)=>{let n=JSON.stringify((Array.isArray(t.reference_songs)?t.reference_songs:[]).filter(e=>(null==e?void 0:e.title)&&"string"==typeof e.title)),i=t.song_language||"Mandarin",o=t.target_artist||"\u672A\u77E5\u827A\u672F\u5BB6",l=t.lyrics_raw||"\u65E0\u6B4C\u8BCD",c={user_id:1,user_input:{song_name:t.song_name,song_language:i,target_singer:o,reference_songs:n,style_description:t.style_note||"",lyrics:l,scene:t.extra_note||""},ai_result:{styles:r.styles,lyrics:r.lyrics,model:a?"mock":s}},u=await Y.db.createPromptRecord(c);return e.success("\u8BB0\u5F55\u5DF2\u6210\u529F\u4FDD\u5B58"),u;},[s,e]);(0,V.useEffect)(()=>{(async()=>{let e=v.get("recordId"),{formValues:t,hasRecord:r,stylesResult:s,lyricsResult:a}=await J(e);r&&(I(s||""),R(a||"")),m.setFieldsValue(t),D(!0);})();},[v,m]);let H=(0,V.useCallback)(async t=>{if(a()){T(!0);try{let a=j.AIProviderFactory.createProvider(s),n=W.buildUserPrompt(t),i=await a.generate({api_key:r,system_prompt:L,user_prompt:n,business_type:F.BusinessType.ARRANGEMENT});if(!i.success)throw Error(i.error||"AI\u751F\u6210\u5931\u8D25");let o=X.parseResponse(i.content);I(o.styles),R(o.lyrics),e.success("\u63D0\u793A\u8BCD\u5DF2\u6210\u529F\u751F\u6210\uFF01"),await B(t,o,!1);}catch(r){let t=r instanceof Error?r.message:`\u{8C03}\u{7528} ${s} API \u{5931}\u{8D25}\u{FF0C}\u{8BF7}\u{68C0}\u{67E5} API Key \u{6216}\u{7A0D}\u{540E}\u{518D}\u{8BD5}\u{3002}`;e.error(t);}finally{T(!1);}}},[a,r,s,e]),$=(0,V.useCallback)(async()=>{T(!0);try{let t=m.getFieldsValue(),r=await z();I(r.styles),R(r.lyrics),e.success("\u6A21\u62DF\u751F\u6210\u5DF2\u5B8C\u6210"),await B(t,r,!0);}catch(t){e.error("\u6A21\u62DF\u751F\u6210\u5931\u8D25\uFF0C\u8BF7\u7A0D\u540E\u518D\u8BD5");}finally{T(!1);}},[m,e]),Z=(0,V.useCallback)(()=>{$();},[$]);return(0,n.jsxs)(n.Fragment,{children:[t,(0,n.jsxs)(i.PageContainer,{children:[(0,n.jsx)(M.ApiKeyAlert,{visible:u,onNavigateToSettings:h}),(0,n.jsx)(O.default,{spinning:w,fullscreen:!0,size:"large"}),(0,n.jsxs)(A.default,{gutter:[24,0],children:[(0,n.jsx)(S.default,{xxl:8,xl:8,lg:12,md:24,sm:24,xs:24,children:(0,n.jsx)(o.ProCard,{title:(0,n.jsx)("span",{onClick:Z,style:{cursor:"pointer"},children:"\u7FFB\u5531\u914D\u7F6E"}),style:{height:"100%"},children:P?(0,n.jsxs)(l.ProForm,{form:m,layout:"vertical",onFinish:H,submitter:{render:()=>(0,n.jsx)(x.default,{vertical:!0,gap:"small",style:{marginTop:16},children:(0,n.jsx)(b.default,{type:"primary",onClick:()=>m.submit(),loading:w,size:"large",block:!0,children:"\u751F\u6210\u63D0\u793A\u8BCD"})})},children:[(0,n.jsx)(g.default,{name:"song_name",label:"\u6B4C\u66F2\u540D\u79F0",placeholder:"\u8BF7\u8F93\u5165\u6B4C\u66F2\u540D\u79F0\uFF0C\u4EC5\u4F5C\u4E3A\u8BB0\u5F55\u65B9\u4FBF\u67E5\u8BE2",rules:K.songName,fieldProps:q.songName}),(0,n.jsx)(d.default,{name:"song_language",label:"\u6B4C\u66F2\u8BED\u8A00",placeholder:"\u8BF7\u9009\u62E9\u6B4C\u66F2\u8BED\u8A00",rules:K.language,options:[{value:"Mandarin",label:"\u534E\u8BED\uFF08\u666E\u901A\u8BDD\uFF09"},{value:"Cantonese",label:"\u7CA4\u8BED"},{value:"Minnan",label:"\u95FD\u5357\u8BED"},{value:"English",label:"\u82F1\u8BED"},{value:"Korean",label:"\u97E9\u8BED"},{value:"Japanese",label:"\u65E5\u8BED"},{value:"Other",label:"\u5176\u4ED6"}]}),(0,n.jsx)(g.default,{name:"target_artist",label:"\u60F3\u6A21\u4EFF\u54EA\u4F4D\u827A\u672F\u5BB6\uFF1F",placeholder:"\u4F8B\u5982\uFF1A\u5F20\u60E0\u59B9\u3001\u9648\u5955\u8FC5\u3001\u5468\u6770\u4F26\u7B49",rules:K.artistName,fieldProps:q.artistName}),(0,n.jsx)(c.ProFormList,{actionRef:f,name:"reference_songs",label:"\u53C2\u8003\u6B4C\u66F2\uFF08\u53EF\u9009\uFF0C\u6700\u591A 3 \u9996\uFF09",initialValue:[{title:"",artist:""}],creatorButtonProps:{creatorButtonText:"\u6DFB\u52A0\u53C2\u8003\u6B4C\u66F2",type:"dashed",block:!0},deleteIconProps:{tooltipText:"\u5220\u9664\u8BE5\u53C2\u8003\u6B4C\u66F2"},copyIconProps:!1,max:3,children:e=>(0,n.jsxs)(k.default,{style:{width:"100%"},children:[(0,n.jsx)(g.default,{name:"title",placeholder:"\u6B4C\u66F2\u540D",rules:K.referenceSongTitle,fieldProps:{style:{width:"100%"},...q.referenceSongTitle}}),(0,n.jsx)(g.default,{name:"artist",placeholder:"\u6F14\u5531\u8005\uFF08\u53EF\u9009\uFF09",rules:K.referenceSongArtist,fieldProps:{style:{width:"100%"},...q.referenceSongArtist}})]},e.name)}),(0,n.jsx)(y.default,{name:"style_note",label:"\u98CE\u683C\u5907\u6CE8\uFF08\u53EF\u9009\uFF09",placeholder:"\u4F8B\u5982\uFF1A\u4E3B\u6B4C\u8981\u50CF\u300A\u4EBA\u8D28\u300B\u4E00\u6837\u6781\u5EA6\u514B\u5236\uFF0C\u526F\u6B4C\u63A5\u8FD1\u300A\u542C\u6D77\u300B\u7684\u60C5\u7EEA\u7206\u53D1\u3002",fieldProps:{showCount:!0,rows:3}}),(0,n.jsx)(y.default,{name:"extra_note",label:"\u7279\u6B8A\u8BF4\u660E\uFF08\u5982\u573A\u666F\u3001\u53D7\u4F17\u7B49\uFF0C\u53EF\u9009\uFF09",placeholder:"\u4F8B\u5982\uFF1A\u6F14\u5531\u4F1A\u73B0\u573A\u7248\u3001\u5F55\u97F3\u5BA4\u7248\u672C\u7B49",fieldProps:{showCount:!0,rows:3}}),(0,n.jsx)(y.default,{name:"lyrics_raw",label:"\u6BB5\u843D\u4E0E\u6B4C\u8BCD",placeholder:"\u8BF7\u586B\u5199\u6B4C\u8BCD\uFF0C\u5E76\u4F7F\u7528\u4EFB\u610F\u6807\u7B7E\u5212\u5206\u6BB5\u843D\uFF0C\u4F8B\u5982\uFF1A\u3010\u4E3B\u6B4C\u3011\u3001\u3010\u526F\u6B4C\u3011\u3001[Verse]\u3001[Chorus] \u7B49",rules:K.lyrics,fieldProps:q.lyrics})]}):(0,n.jsx)("div",{style:{textAlign:"center",padding:"40px 0"},children:(0,n.jsx)(O.default,{size:"large"})})})}),(0,n.jsx)(S.default,{xxl:8,xl:8,lg:6,md:12,sm:12,xs:12,children:(0,n.jsx)(M.ResultCard,{title:"Styles \u63D0\u793A\u8BCD\uFF08\u53EF\u76F4\u63A5\u590D\u5236\u7528\u4E8E Suno\uFF09",value:_,onCopy:()=>(0,G.copyToClipboard)(_,"Styles")})}),(0,n.jsx)(S.default,{xxl:8,xl:8,lg:6,md:12,sm:12,xs:12,children:(0,n.jsx)(M.ResultCard,{title:"Lyrics \u63D0\u793A\u8BCD\uFF08\u53EF\u76F4\u63A5\u590D\u5236\u7528\u4E8E Suno\uFF09",value:N,onCopy:()=>(0,G.copyToClipboard)(N,"Lyrics")})})]})]})]});};}}]);
//# sourceMappingURL=c27184d7-async.faab0806.js.map