...
Suno 翻唱编曲大师是一款专为 Suno 翻唱创作者设计的 AI 工具，帮助用户用中文描述音乐风格和编曲想法，自动生成符合 Suno 官方术语体系的高质量英文提示词。
...
1. **智能生成 Styles**：根据用户的中文风格描述，自动生成符合 Suno 官方术语体系的高质量英文 Styles
2. **结构化 Lyrics 属性**：自动识别并标准化歌词段落标签，为每段歌词生成结构化的属性注释
