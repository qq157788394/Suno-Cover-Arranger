...
const LyricsRecordDetail = ({ record, onClose })=>{
    ...
    const masterInfo = getMasterInfo(record === null || record === void 0 ? void 0 : record.form_data.master_id);
    // Segmented选项
...
_s(LyricsRecordDetail, "JLxl/5sC0ZRhhVm8HsV8hSROSyw=", false, function() {
    return [
        _max.useModel
    ];
});
...
_s(LyricsRecordsPage, "b6lEC9zoMoBdH3P6dzgA+qD19vk=", false, function() {
    return [
        _max.useNavigate,
